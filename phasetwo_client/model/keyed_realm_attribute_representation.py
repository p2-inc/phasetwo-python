...
class KeyedRealmAttributeRepresentation(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        @staticmethod
        def additional_properties() -> typing.Type['RealmAttributeRepresentation']:
            return RealmAttributeRepresentation
    
    def __getitem__(self, name: typing.Union[str, ]) -> 'RealmAttributeRepresentation':
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    def get_item_oapg(self, name: typing.Union[str, ]) -> 'RealmAttributeRepresentation':
    ...
    def __new__(
        ...
        **kwargs: 'RealmAttributeRepresentation',
