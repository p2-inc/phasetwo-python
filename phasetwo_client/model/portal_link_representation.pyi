...
class PortalLinkRepresentation(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["user", "link", "redirect", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["user", "link", "redirect", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        redirect: typing.Union[MetaOapg.properties.redirect, str, schemas.Unset] = schemas.unset,
