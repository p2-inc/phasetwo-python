...
SchemaFor200ResponseBodyApplicationJson = WebhookRepresentation
...
class GetWebhookById(BaseApi):
    ...
    def get_webhook_by_id(
        ...
        return self._get_webhook_by_id_oapg(
