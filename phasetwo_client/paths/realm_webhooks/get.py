...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['WebhookRepresentation']:
            return WebhookRepresentation

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['WebhookRepresentation'], typing.List['WebhookRepresentation']],
    ...
    def __getitem__(self, i: int) -> 'WebhookRepresentation':
