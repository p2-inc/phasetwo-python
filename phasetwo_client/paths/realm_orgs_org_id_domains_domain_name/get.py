...
request_path_domain_name = api_client.PathParameter(
    name="domainName",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationJson = OrganizationDomainRepresentation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_organization_domain_oapg(
        self,
...
class GetOrganizationDomain(BaseApi):
    ...
    def get_organization_domain(
        ...
        return self._get_organization_domain_oapg(
