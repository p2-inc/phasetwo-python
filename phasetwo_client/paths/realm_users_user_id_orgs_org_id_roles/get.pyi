...
class BaseApi(api_client.Api):
    @typing.overload
    def _realm_users_user_id_orgs_org_id_roles_get_oapg(
        self,
...
class RealmUsersUserIdOrgsOrgIdRolesGet(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def realm_users_user_id_orgs_org_id_roles_get(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def realm_users_user_id_orgs_org_id_roles_get(
        ...
        return self._realm_users_user_id_orgs_org_id_roles_get_oapg(
