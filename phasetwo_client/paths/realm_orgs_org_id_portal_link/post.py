...
SchemaFor200ResponseBodyApplicationJson = PortalLinkRepresentation
...
class CreatePortalLink(BaseApi):
    ...
    def create_portal_link(
        ...
        return self._create_portal_link_oapg(
            body=body,
