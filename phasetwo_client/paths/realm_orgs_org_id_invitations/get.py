...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['InvitationRepresentation']:
            return InvitationRepresentation

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['InvitationRepresentation'], typing.List['InvitationRepresentation']],
    ...
    def __getitem__(self, i: int) -> 'InvitationRepresentation':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_organization_invitations_oapg(
        self,
...
class GetOrganizationInvitations(BaseApi):
    ...
    def get_organization_invitations(
        ...
        return self._get_organization_invitations_oapg(
