...
# body param
SchemaForRequestBodyApplicationJson = OrganizationRoleRepresentation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _update_organization_role_oapg(
        self,
...
class UpdateOrganizationRole(BaseApi):
    ...
    def update_organization_role(
        ...
        return self._update_organization_role_oapg(
            body=body,
