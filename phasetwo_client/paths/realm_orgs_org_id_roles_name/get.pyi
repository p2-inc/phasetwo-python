...
SchemaFor200ResponseBodyApplicationJson = OrganizationRoleRepresentation
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_organization_role_oapg(
        self,
...
class GetOrganizationRole(BaseApi):
    ...
    def get_organization_role(
        ...
        return self._get_organization_role_oapg(
