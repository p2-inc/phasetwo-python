...
# body param
SchemaForRequestBodyApplicationJson = OrganizationRepresentation


request_body_organization_representation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_organization_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_organization_representation.serialize(body, content_type)
