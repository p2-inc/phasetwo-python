...
from phasetwo.paths.realm_magic_link.post import CreateMagicLink
from phasetwo.paths.realm_users_user_id_orgs.get import RealmUsersUserIdOrgsGet
from phasetwo.paths.realm_users_user_id_orgs_org_id_roles.get import RealmUsersUserIdOrgsOrgIdRolesGet
from phasetwo.paths.realm_users_user_id_orgs_org_id_roles.patch import RealmUsersUserIdOrgsOrgIdRolesPatch
from phasetwo.paths.realm_users_user_id_orgs_org_id_roles.put import RealmUsersUserIdOrgsOrgIdRolesPut


class UsersApi(
    CreateMagicLink,
    RealmUsersUserIdOrgsGet,
    RealmUsersUserIdOrgsOrgIdRolesGet,
    RealmUsersUserIdOrgsOrgIdRolesPatch,
    RealmUsersUserIdOrgsOrgIdRolesPut,
):
