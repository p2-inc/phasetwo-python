...
# body param
SchemaForRequestBodyApplicationJson = LinkIdentityProviderRepresentation


request_body_link_identity_provider_representation = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _link_idp_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_link_identity_provider_representation.serialize(body, content_type)
