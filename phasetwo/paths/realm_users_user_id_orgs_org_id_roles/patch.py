...
class BaseApi(api_client.Api):
    @typing.overload
    def _realm_users_user_id_orgs_org_id_roles_patch_oapg(
        self,
...
class RealmUsersUserIdOrgsOrgIdRolesPatch(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def realm_users_user_id_orgs_org_id_roles_patch(
        self,
        body: typing.Union[SchemaForRequestBodyApplicationJson,list, tuple, ],
        content_type: typing_extensions.Literal["application/json"] = ...,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def realm_users_user_id_orgs_org_id_roles_patch(
        ...
        return self._realm_users_user_id_orgs_org_id_roles_patch_oapg(
            body=body,
