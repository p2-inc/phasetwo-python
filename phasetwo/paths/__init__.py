...
class PathValues(str, enum.Enum):
    ...
    REALM_ORGS_ORG_ID_INVITATIONS_INVITATION_ID_RESENDEMAIL = "/{realm}/orgs/{orgId}/invitations/{invitationId}/resend-email"
    ...
    REALM_ORGS_ORG_ID_IDPS_LINK = "/{realm}/orgs/{orgId}/idps/link"
